...
const stopGame = (status) => {
  ...
  document.getElementById("game").innerHTML += `<p>The word was: <span 
	class="result-word">${word}</span></p><button id="play-again" class="button-primary px-5 mt-5">
	Play again</button>`;
...
export const startGame = () => {
  ...
  gameDiv.insertAdjacentHTML(
    "beforeend",
    '<button id="quit" class="button-secondary px-2 py-1 mt-4">Quit game</button>'
  );
